...
// Vendored from https://ui.elevenlabs.io/docs/components/live-waveform (elevenlabs/ui registry).
// Canvas2D mic-reactive waveform. `active` drives real getUserMedia analysis, `processing`
// drives a simulated wave while nothing is actively captured (e.g. transcribing).
...
export const LiveWaveform = ({
  ...
  return (
    ...
    >
      {!active && !processing && (
        <div className="absolute top-1/2 right-0 left-0 -translate-y-1/2 border-t-2 border-dotted border-slate-300/40" />
      )}
